...
<style>
    ...
    @media only screen and (max-width: 599px) {
        ...
        .tt-tag .tt-tag-text .tt-tag-toy {
            font-size: 1.25rem;
            line-height: 1em;
            margin-bottom: 5px;
        }

        .tt-tag .tt-tag-buttons {
            display: none;
        }

        /* Extra specificity to defeat beaverbuilder's button media queries */
        .tt-tag .tt-tag-text .tt-tag-buttons-small, .tt-tag-buttons-small button.btn-sm {
            text-justify: center;
            display: block;
        ...
        .tt-tag .tt-tag-text .tt-tag-buttons-small a.btn {
            margin-bottom: 1em;
        }
    }
...
<div class="container mt-2" style="position: relative;">
    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="card">
                <h5 class="card-header text-center">Donate Money</h5>
